...
namespace seneca {
	...
	public:
		Date();
		Date(int day, int month, int year); // constructor with 3 parameters
	...
	public:
		DepositInfo();
		DepositInfo(const char* transit, const char* institution, const char* account); // constructor with 3 parameters
